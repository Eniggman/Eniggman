...
* 📱 **[termux-agent-bridge](https://github.com/Enigman-Termux-lab/termux-agent-bridge)** (skills/termux-agent-bridge)) — Управление вашим Android со средой Termux (Linux) через любого ИИ-агента по протоколу MCP.
